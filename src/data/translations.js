...
export const LANGUAGE_UI = {
  "en": {
    ...
    "accountHeading": "Save ratings to the right therapist",
    ...
    "authIntro": "Sign in only when you want to save ratings, pair with a practice partner, or prepare data for charts.",
    ...
    "selfChartAverage": "{score}/5 average",
    "selfChartCount": "{count} ratings",
  ...
  "no": {
    ...
    "accountHeading": "Lagre vurderinger på riktig terapeut",
    ...
    "authIntro": "Logg inn bare når du vil lagre vurderinger, koble til en øvingspartner eller klargjøre data for grafer.",
    ...
    "selfChartAverage": "{score}/5 i snitt",
    "selfChartCount": "{count} vurderinger",
