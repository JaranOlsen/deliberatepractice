...
export const STATEMENT_TRANSLATIONS = {
  "no": {
    ...
    "dp_staying-in-contact-intense-affect_case-sara_04": {
      ...
      "suggestion": "Skjelvingen viser hvor brått bildet traff. Bli med meg i bare dette suget i magen; vi kan la gulvet minne deg på at innlegget ikke skjer i dette rommet."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-sara_07": {
      ...
      "suggestion": "Draget bortover er sterkt nå. Jeg holder kontakt med deg her; bruk stemmen min og følelsen i hendene til å gi avstanden et navn uten å la den ta deg ut av rommet."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-sara_10": {
      ...
      "suggestion": "Frykten er at gråten åpner seg bredere enn denne timen kan holde. Vi kan bli ved én kant av den sammen og stadig komme tilbake til rommet, så du ikke blir alene med den i kveld."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-michael_05": {
      ...
      "suggestion": "Skjelvingen er her, med forakten fra faren din rett bak. Jeg holder meg stødig mens vi lar skammen bli synlig på en smal nok måte til at den ikke må bekjempes."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-jason_03": {
      ...
      "suggestion": "Rommet begynner å vippe idet scenen ved kjøkkenet kommer fram. Jeg blir hos deg i én liten del av den, nok til at skammen kan være her uten å sluke rommet."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-jason_05": {
      ...
      "suggestion": "Du prøver å skjule panikken, og det gjør det trangere. Jeg kan bli hos deg mens pusten er ujevn; vi roer den uten å kreve at du ser samlet ut."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-jason_08": {
      ...
      "suggestion": "Den gamle seminarfølelsen har trengt seg inn i dette rommet. Jeg blir hos deg mens vi skiller dette rommet fra det blikket, og lar bare litt av fanget-følelsen være her."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-laura_02": {
      ...
      "suggestion": "Nummenheten beskytter deg mot for mye. Jeg blir ved kanten av den sammen med deg og ser etter det minste signalet uten å presse gjennom avstengingen."
    },
    "dp_staying-in-contact-intense-affect_case-laura_03": {
      ...
      "suggestion": "Den glassaktige avstanden er allerede i ferd med å ta deg bort. Jeg holder stemmen rolig og nær mens vi bare holder en liten del av følelsen av å vente på fare."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-laura_07": {
      ...
      "suggestion": "Det er skremmende når kunnskapen om at døren er lukket ikke når kroppen. La min stødighet hjelpe deg å holde begge sannheter: faresignalet og rommet vi faktisk er i."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-laura_10": {
      ...
      "suggestion": "Det er farepunktet: Hvis følelsen åpner seg, er du redd for å forsvinne. Jeg blir hos deg ved den minste kanten, og vi stopper før det blir for mye."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-carlos_05": {
      ...
      "suggestion": "Jeg er glad du fanget dette før trangen ble handling. Jeg er tydelig og nær med deg: impulsen til å knuse noe kan sies her mens vi lar bølgen gå ned uten at noen blir skadet."
    },
    "dp_staying-in-contact-intense-affect_case-carlos_06": {
      ...
      "suggestion": "Kampen er allerede i brystet og skuldrene dine. Jeg blir hos deg mens vi lar den kjennes som en bølge, ikke som en ordre."
    },
    "dp_staying-in-contact-intense-affect_case-carlos_07": {
      ...
      "suggestion": "Jeg trekker meg ikke unna hvor voldelig det bildet er. Vi holder det i ord her, og jeg blir hos ydmykelsen og raseriet uten å la dem bli handling."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-nina_05": {
      ...
      "suggestion": "Den kollapsen har vært holdt tilbake lenge. Jeg er her med deg mens tyngden viser seg, og vi lar bare en tålelig mengde bæres i dette rommet."
    },
    "dp_staying-in-contact-intense-affect_case-nina_06": {
      ...
      "suggestion": "Å stoppe kjennes farlig fordi alles behov kommer fossende inn, også dine. Jeg blir her med deg mens en liten del av tårene dine får plass før du må ta vare på noen."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-aisha_02": {
      ...
      "suggestion": "Jeg er veldig glad for at du sier det, og jeg blir nær. Brenningen er så desperat at skade begynner å se ut som bevis på at du finnes; vi holder deg trygg mens behovet for å kjenne at du er virkelig blir i ord sammen med meg."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-aisha_08": {
      ...
      "suggestion": "Jeg blir hos deg mens trangen til å klore blir sterk. Vi holder hendene dine trygge og lar behovet for noe virkelig bli sagt her i stedet for at huden må bære det."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-aisha_10": {
      ...
      "suggestion": "Avlysningen treffer som om gulvet forsvinner, og jeg lar deg ikke være alene i det her. Vi setter ord på skrekken for å bli forlatt mens du er nok forankret til å bli her med meg."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-david_02": {
      ...
      "suggestion": "Det er vanskelig å høre at terapien kjennes verre og at min erfaring kan være en del av det, og jeg vil bli hos deg i stedet for å forsvare meg. Skuffelsen og sinnet trenger rom, og vi må også se nøye på om dette arbeidet hjelper."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-david_08": {
      ...
      "suggestion": "Dette er alvorlig, og jeg blir hos deg mens du sier det. Vi kan møte skammen og ansvaret uten å unnskylde skaden og uten å la «ingen vei tilbake» bli den eneste sannheten i rommet."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-marcus_01": {
      ...
      "suggestion": "Bølgen stiger, og frykten er at den skal ta deg tilbake dit. Jeg blir hos deg ved kanten av den og hjelper deg å beholde én fot i dette rommet."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-marcus_03": {
      ...
      "suggestion": "Den svingen fra nummen til oversvømt er skremmende, og jeg er her med deg i den. Vi kan velge ett lite signal og la resten vente, så ikke hele minnet tar over."
    },
    ...
    "dp_staying-in-contact-intense-affect_case-marcus_06": {
      ...
      "suggestion": "Den stillheten legger seg tungt og endelig, som om du er låst inne der igjen. Jeg er her med deg mens vi setter kort ord på vekten og lar dette rommet være til stede også."
    },
    "dp_staying-in-contact-intense-affect_case-marcus_07": {
      ...
      "suggestion": "Summingen sier at systemet ditt fortsatt er på vakt, selv hjemme. Jeg blir hos deg mens vi holder bare en tynn tråd av den og hjelper skanningen å vite at dette er rommet du er i nå."
    },
    "dp_staying-in-contact-intense-affect_case-marcus_08": {
      ...
      "suggestion": "Frykten er at følelsen skal få fortid og nåtid til å falle sammen til ett sted. Jeg er her med deg mens vi holder det mindre enn hele greia, og så stopper vi tydelig før det sluker deg."
    },
    ...
    "dp_self-disclosure_case-sara_06": {
      ...
      "suggestion": "Jeg kan ikke love hva et år vil bringe, og jeg vil ikke trøste deg med en sikkerhet jeg ikke har. Jeg kjenner ekte håp sammen med deg her. Hva skjer når du hører håp fra meg samtidig som frykten sier at du fortsatt kan være alene?"
    },
    ...
    "dp_self-disclosure_case-sara_10": {
      ...
      "suggestion": "Jeg bryr meg om deg i denne terapirelasjonen; det er ikke bare en rolle. Grensene er en del av å ta ansvar for omsorgen. Hvordan er det å høre både omsorgen og grensen samtidig?"
    },
    ...
    "dp_self-disclosure_case-michael_02": {
      ...
      "suggestion": "Jeg kjenner sinne i meg selv også, og jeg ser ikke ned på ditt. Jeg kjenner meg stødig nok til å være med det her. Hvordan er det å høre at jeg ikke står over følelsen du er redd jeg skal dømme?"
    },
    ...
    "dp_self-disclosure_case-michael_07": {
      ...
      "suggestion": "Ja, det går inn på meg. Jeg holder meg rolig med vilje, så vi kan fortsette å se på det uten at noen av oss trekker seg unna. Hva legger du merke til når jeg sier at roen min ikke er avstand?"
    },
    ...
    "dp_self-disclosure_case-michael_09": {
      ...
      "suggestion": "Detaljer om min relasjon holder jeg private her, og jeg vet noe om arbeidet med å roe ned sinne før det renner over i relasjoner. Jeg ser ikke på sinnet ditt fra avstand. Hva betyr det for deg om jeg kjenner noe av dette innenfra?"
    },
    ...
    "dp_self-disclosure_case-jason_09": {
      ...
      "suggestion": "Ja, jeg kan også bli nervøs i grupper iblant. Jeg sier det fordi jeg ikke ser frykten din som rar eller fremmed. Hvordan er det å høre at det ikke bare er deg?"
    },
    ...
    "dp_self-disclosure_case-laura_04": {
      ...
      "suggestion": "Ja, jeg har arbeidet med traumer før, og jeg ser ikke avstengningen din som en feil. Jeg vil også si fra hvis jeg tenker at vi trenger mer støtte. Hvordan er det å høre at avstengningen ikke gjør dette umulig for meg?"
    },
    ...
    "dp_self-disclosure_case-laura_08": {
      ...
      "suggestion": "Jeg vil ikke at vennligheten min skal presse fram noe eller gjøre deg avhengig av meg. Jeg er varsom med omsorg her; den må være noe de beskyttende delene dine kan teste. Hva ville hjulpet deg å beholde valget mens du tar imot noe av den?"
    },
    ...
    "dp_self-disclosure_case-laura_10": {
      ...
      "suggestion": "Ja, jeg tror det er mulig å kjenne mer igjen, og jeg sier det ikke bare for å være snill. Jeg kjenner tålmodighet med veien dit. Hva skjer når du hører troen min uten at du blir bedt om å presse den fram?"
    },
    ...
    "dp_self-disclosure_case-carlos_05": {
      ...
      "suggestion": "Jeg kjenner meg stødig nok til å sitte med sinnet ditt. Jeg er ikke her for å overkjøre deg eller bli overkjørt av deg; dette trenger ikke bli en konkurranse. Hvordan er det å høre at jeg kan være med sinnet ditt uten å slåss med deg?"
    },
    ...
    "dp_self-disclosure_case-carlos_07": {
      ...
      "suggestion": "Ja. Å roe ned pusten hjelper meg å beholde valg når aktiveringen stiger, og derfor bruker jeg det her. Jeg ber deg ikke gjøre noe jeg ser på som svakt. Hva legger du merke til når du hører det fra meg?"
    },
    "dp_self-disclosure_case-carlos_08": {
      "text": "[Nysgjerrig] Er du gift, og mister du noen gang besinnelsen med folk du er glad i?",
      "suggestion": "Detaljer om min relasjon holder jeg private her, og jeg kan si at sinne er menneskelig for meg. Jeg sitter ikke over ditt sinne og dømmer det. Hvordan er det å høre både privatheten og ærligheten i det?"
    },
    ...
    "dp_self-disclosure_case-nina_04": {
      ...
      "suggestion": "Jeg kjenner også skyld rundt hvile fra mitt eget liv, og det hjelper meg å ta din skyld på alvor i stedet for å se den som bare ditt problem. Jeg behandler ikke skylden din som dum. Hvordan er det å høre det fra meg?"
    },
    ...
    "dp_self-disclosure_case-nina_10": {
      ...
      "suggestion": "Ja, jeg mener at du fortjener omsorg før du har gjort deg fortjent til noe som helst. Jeg er tydelig på det her, og den tvilende delen trenger ikke tro meg raskt. Hva skjer når jeg sier det så direkte?"
    },
    ...
    "dp_self-disclosure_case-aisha_03": {
      ...
      "suggestion": "Du skremte meg ikke bort. Jeg ble bekymret fordi sikkerheten din betyr noe, og jeg er fortsatt her sammen med deg. Hvordan er det å høre at bekymringen min betyr varsom nærhet, ikke avstand?"
    },
    ...
    "dp_self-disclosure_case-aisha_09": {
      ...
      "suggestion": "Jeg la merke til at jeg var forsinket, og jeg beklager. Det var ikke ingenting for meg, og jeg kan se for meg at det traff som om du ikke betydde noe. Hva skjedde i deg da jeg ikke var her presis?"
    },
    ...
    "dp_self-disclosure_case-david_08": {
      ...
      "suggestion": "Jeg vil svare varsomt: Jeg kan se deg som en attraktiv person, og jeg forholder meg ikke til deg romantisk eller seksuelt. Dette er en terapirelasjon. Jeg ser deg heller ikke bare som en vanskelig klient. Hvordan er det å høre alt det?"
    },
    ...
    "dp_self-disclosure_case-marcus_08": {
      ...
      "suggestion": "Traumefortellinger går inn på meg, og de skremmer meg ikke bort. Jeg arbeider for å holde meg forankret i dem, og jeg kjenner meg stødig nok til å høre din i det tempoet du velger. Hvordan er det å høre det?"
    },
    ...
    "dp_marker-recognition-chairwork_case-sara_04": {
      ...
      "suggestion": "Det høres ut som en hard selvkritisk stemme angriper deg for at du ønsket nærhet. Ville det være greit å sette kritikeren i én stol og delen som ønsket kjærlighet i den andre? Start her som kritikeren og si angrepet direkte; så bytter vi og hører hva det gjør med deg."
    },
    "dp_marker-recognition-chairwork_case-sara_05": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med venninnen din rundt å bli skyndet forbi sorgen og føle deg latterliggjort. Hvis du vil, kan vi sette henne i den tomme stolen og la deg si den første linjen direkte: «slutt å skynde på meg». Så stopper vi opp og ser hva mer som trenger å bli sagt."
    },
    ...
    "dp_marker-recognition-chairwork_case-sara_07": {
      ...
      "suggestion": "Det høres ut som en skyldstemme gjør behovet ditt for nærhet til bevis mot deg. Hvis du vil, kan vi bruke to stoler for å gjøre mønsteret tydeligere. Fra denne stolen sier du til henne at hun presset for hardt og burde vært lettere å elske; så bytter vi og hører fra siden som trengte ham."
    },
    ...
    "dp_marker-recognition-chairwork_case-sara_09": {
      ...
      "suggestion": "Det høres ut som bekymring og selvangrep prøver å beskytte deg ved å skremme deg før noe har skjedd. Vi kan bruke to stoler for å høre hvordan stemmen virker. Fra denne stolen sier du alle reglene og spådommene; så bytter vi og hører fra den redde siden som tar imot dem."
    },
    ...
    "dp_marker-recognition-chairwork_case-michael_04": {
      ...
      "suggestion": "Det høres ut som et selvkritisk angrep kommer etter sinnet og lar deg sitte alene med skammen. Vi kan sette den angripende stemmen i én stol og delen som smalt i den andre. Fra denne stolen sier du kritikken direkte: «du er akkurat som ham, du lærer aldri»; så bytter vi og hører hva det gjør inni deg."
    },
    "dp_marker-recognition-chairwork_case-michael_05": {
      ...
      "suggestion": "Det peker mot et uavsluttet oppgjør med faren din rundt aldri å strekke til og fortsatt prøve å vinne hans godkjenning. Hvis du vil, kan vi hente ham inn i den tomme stolen og la deg si setningen direkte, én linje om gangen, mens vi holder kontakt med både sinne og sårhet."
    },
    ...
    "dp_marker-recognition-chairwork_case-michael_07": {
      ...
      "suggestion": "Det høres ut som en bekymringsdel som presser deg med katastrofer. Kan vi sette opp to stoler i noen minutter? Sitt her som bekymringen og fortell ham nøyaktig hva én feil ville bevise; så bytter vi og hører fra siden som blir presset."
    },
    "dp_marker-recognition-chairwork_case-michael_08": {
      ...
      "suggestion": "Det er en hard selvkritisk splittelse rundt drikking, svakhet og kontroll. Kan vi sette den angripende stemmen i én stol og den skamfulle delen i den andre? Fra denne stolen sier du angrepet direkte; så bytter vi, slik at du kan høre hva det gjør og begynne å svare."
    },
    ...
    "dp_marker-recognition-chairwork_case-jason_01": {
      ...
      "suggestion": "Jeg hører en hard advarsel som gjemmer deg før noen kan le. Ville det være greit å gi den advarende siden én stol og den stillere, utsatte siden den andre? Start som advarselen og si hvorfor han må holde seg liten."
    },
    ...
    "dp_marker-recognition-chairwork_case-jason_03": {
      ...
      "suggestion": "Det høres ut som en selvavbrytelse som hindrer deg i å søke kontakt ved å stramme til, vente og tie. Hvis du vil, kan du flytte deg til denne stolen og vise hvordan du får ham til å vente på den perfekte åpningen; så bytter vi tilbake og hører fra siden som ville bli med."
    },
    "dp_marker-recognition-chairwork_case-jason_04": {
      ...
      "suggestion": "Det høres ut som en selvkritisk stemme gjør én klein hilsen til en hel dom over deg. Vi kan sette kritikeren i én stol og den flaue siden i den andre. Først lar vi kritikeren si hva den sier om å være creepy og rar; så bytter vi og hører fra siden som bare prøvde å si hei."
    },
    "dp_marker-recognition-chairwork_case-jason_05": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med de klassekameratene og med spørsmålet som lærte deg å snakke mindre. Vi kan sette dem i den tomme stolen og la deg spørre: «hva var det som var så morsomt med meg?» langsomt og bare noen få ord om gangen."
    },
    "dp_marker-recognition-chairwork_case-jason_06": {
      ...
      "suggestion": "Det høres ut som du avbryter komplimentet før det kan nå inn ved å komme kritikken i forkjøpet. Vi kan bruke to stoler. Fra denne stolen viser du hvordan du avleder og peker på det kleine; så bytter vi og hører fra siden som kanskje vil ta imot komplimentet."
    },
    "dp_marker-recognition-chairwork_case-jason_07": {
      ...
      "suggestion": "Det høres ut som en katastrofebekymring forbereder deg på ydmykelse ved å oversvømme deg med scener. Hvis du vil, kan vi bruke to stoler: sitt her som bekymringen og liste opp de fryktede øyeblikkene direkte; så bytter vi og hører fra delen som må komme dit etter å ha hørt alt det."
    },
    "dp_marker-recognition-chairwork_case-jason_08": {
      ...
      "suggestion": "Det høres ut som en kritiker gjør det å bli utelatt til en dom over verdien din, mens såretheten blir dekket til. Vi kan sette den stemmen i én stol og den sårede siden i den andre. Fra denne stolen sier du: «dette er det som skjer når folk kan velge deg bort»; så bytter vi så den sårede siden får mulighet til å svare."
    },
    "dp_marker-recognition-chairwork_case-jason_09": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med den gamle vennen, med et spørsmål som aldri fikk lande noe sted. Hvis du vil, kan vi plassere ham i den tomme stolen og la deg si den første linjen direkte: «du forsvant, og jeg fikk aldri vite hvorfor.» Så stopper vi opp og legger merke til hva den yngre delen av deg fortsatt trenger å si."
    },
    ...
    "dp_marker-recognition-chairwork_case-laura_04": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med eksen din rundt å bli sittende alene med skylden. Hvis det kjennes håndterbart, kan vi sette ham i den tomme stolen og la deg stille spørsmålet direkte: «visste du at jeg kom til å bære skylden for oss begge?»"
    },
    "dp_marker-recognition-chairwork_case-laura_05": {
      ...
      "suggestion": "Det høres ut som en hard selvkritisk stemme kaller deg skadet og bruker den dommen til å holde folk unna. Hvis det kjennes trygt nok, kan vi sette den stemmen i én stol og delen av deg som hører den i den andre. Fra denne stolen sier du advarselen direkte; så bytter vi og hører hvordan det er å bli kalt skadet."
    },
    ...
    "dp_marker-recognition-chairwork_case-laura_07": {
      ...
      "suggestion": "Det høres ut som en selvbebreidende kritiker angriper delen som stolte og ønsket trygghet. Kan vi sette kritikeren i denne stolen og la den legge frem saken direkte: «du burde ha visst bedre, du var dum som stolte på ham»? Så bytter vi til den tillitsfulle delen som ble såret og hører hva som skjer der."
    },
    ...
    "dp_marker-recognition-chairwork_case-laura_10": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med moren din rundt ikke å bli beskyttet eller nådd etter at det skjedde. Hvis det kjennes håndterbart, kan vi hente henne inn i den tomme stolen og la deg spørre: «hvorfor kom du aldri inn på rommet mitt etterpå?» bare så langt det kjennes tålelig."
    },
    ...
    "dp_marker-recognition-chairwork_case-carlos_04": {
      ...
      "suggestion": "Det høres ut som et hardt selvangrep etter sinnet. Kan vi sette stemmen som kaller deg et monster i én stol og delen som blir truffet av det i den andre? Start som den angripende stemmen og si ordet monster direkte; så lar vi den angrepne siden svare."
    },
    ...
    "dp_marker-recognition-chairwork_case-carlos_07": {
      ...
      "suggestion": "Det høres ut som en katastrofebekymring rundt respekt. Kan vi sette bekymringen i én stol og la den forutsi nøyaktig hva som skjer hvis han sier imot? Start med himlingen med øynene og følg kjeden; så bytter vi og hører fra faren under det presset."
    },
    "dp_marker-recognition-chairwork_case-carlos_08": {
      ...
      "suggestion": "Det høres ut som en skambasert kritiker blokkerer hjelp ved å koble terapi til svakhet og ydmykelse. Kan vi sette den stemmen i denne stolen og la den si «bare tapere trenger hjelp» med faren din sin tone? Så bytter vi til siden som vil noe annet for familien din og hører hva det koster å lytte til den kritikeren."
    },
    ...
    "dp_marker-recognition-chairwork_case-nina_01": {
      ...
      "suggestion": "Det høres ut som en skyldstemme gjør det til din feil at ekteskapet tok slutt, ved å angripe behovene og utmattelsen din. Vi kan bruke to stoler for å høre skylden tydelig. Fra denne stolen sier du til henne at hun burde vært søtere og trengt mindre; så bytter vi og hører hva det gjør med henne."
    },
    ...
    "dp_marker-recognition-chairwork_case-nina_03": {
      ...
      "suggestion": "Det høres ut som budskapet om å være et dårlig menneske stopper sinnet og sender deg tilbake til omsorgen. Kan vi bruke to stoler for å gjøre den sekvensen synlig? Fra denne stolen sier du til henne at hun er dårlig fordi hun blir sint; så bytter vi og lar sinnet si noen enkle ord."
    },
    "dp_marker-recognition-chairwork_case-nina_04": {
      ...
      "suggestion": "Det høres ut som en selvkritisk stemme angriper behovet ditt for hvile gjennom god-mor-regelen. Vi kan sette den regelen i én stol og den utslitte siden i den andre. Først lar vi regelen si «egoistisk, lat, hva slags mor gjemmer seg?»; så bytter vi og hører den trøtte siden."
    },
    ...
    "dp_marker-recognition-chairwork_case-nina_06": {
      ...
      "suggestion": "Det høres ut som du avbryter sinnet ved å gå rett inn i omsorg og holde huset i gang. Vi kan bruke to stoler for å gjøre avbrytelsen synlig. Fra denne stolen viser du hvordan du smiler, spør om middag og dekker over sinnet; så bytter vi og lar sinnet si én enkel setning det aldri fikk sagt."
    },
    "dp_marker-recognition-chairwork_case-nina_07": {
      ...
      "suggestion": "Det høres ut som en selvkritisk stemme gjør verdien din avhengig av konstant omsorg. Vi kan sette stemmen som sier «ubrukelig» i én stol og den slitne delen i den andre. Fra denne stolen sier du til henne at den manglende middagen beviser at hun svikter; så bytter vi og hører fra den utslitte siden som har båret så mye."
    },
    ...
    "dp_marker-recognition-chairwork_case-nina_09": {
      ...
      "suggestion": "Det høres ut som du avbryter grensen din før den får holde, som om forklaringen må viske ut nei-et. Vi kan bruke to stoler: Fra denne stolen viser du hvordan du mykner, forklarer og gjør nei til ja; så bytter vi til siden som ville si nei og lar den si hva den trengte."
    },
    "dp_marker-recognition-chairwork_case-nina_10": {
      ...
      "suggestion": "Det høres ut som en bekymringsdel presser deg tilbake til å bære alle ved å forutsi sammenbrudd. Ville du være villig til å sette bekymringen i denne stolen? La den liste opp de fryktede konsekvensene med egne ord; så bytter vi og hører fra den utslitte siden som prøver å hvile under det presset."
    },
    ...
    "dp_marker-recognition-chairwork_case-aisha_04": {
      ...
      "suggestion": "Det høres ut som et brutalt selvangrep kommer etter kontaktpanikk og prøver å kontrollere ventingen. Vi kan sette den angripende stemmen i én stol og den redde siden i den andre. Fra denne stolen sier du hva den kaller deg etter meldingene; så bytter vi og lar den redde siden svare i små, støttede steg."
    },
    "dp_marker-recognition-chairwork_case-aisha_05": {
      "text": "[Rasende] Jeg vil fortsatt sette moren min i en stol og si: «Du lot meg bli igjen hos mennesker som skadet meg.» Jeg var et barn, og du fortsatte å velge dem, og så lot du som om du var sjokkert over at jeg var sint.",
      "suggestion": "Det høres ut som et uavsluttet oppgjør med moren din rundt å bli stående uten beskyttelse, og så få sinnet behandlet som problemet. Hvis det kjennes trygt nok, kan vi hente henne inn i den tomme stolen og la deg si den første setningen direkte, med pauser og valgfrihet."
    },
    ...
    "dp_marker-recognition-chairwork_case-aisha_07": {
      ...
      "suggestion": "Det høres ut som en katastrofebekymring som oversvømmer deg med scener der du blir byttet ut. Hvis du vil, kan vi bruke to stoler: sitt her som bekymringen og vise scenene høyt, én om gangen; så bytter vi til siden som blir oversvømt av dem."
    },
    ...
    "dp_marker-recognition-chairwork_case-aisha_09": {
      ...
      "suggestion": "Det høres ut som en selvkritisk splittelse rundt å trenge nærhet, der angrepet kommer før noen andre kan avvise deg. Vi kan sette den angripende stemmen i én stol og den lengtende siden i den andre. Først lar vi angrepet si «slutt å tigge, slutt å oppføre deg som et barn»; så bytter vi så den lengtende siden ikke blir alene med det."
    },
    ...
    "dp_marker-recognition-chairwork_case-david_01": {
      ...
      "suggestion": "Det høres ut som en krevende selvkritisk stemme gjør verdien din avhengig av å være eksepsjonell og behandler det ordinære som om forlattheten allerede har begynt. Kan vi sette kravet i én stol og siden som betaler prisen i den andre? Fra denne stolen argumenterer du for at ordinær betyr utskiftbar; så bytter vi."
    },
    ...
    "dp_marker-recognition-chairwork_case-david_06": {
      ...
      "suggestion": "Det høres ut som prestasjonslisten avbryter skammen før den kan kjennes, men legger igjen en ny kostnad. Ville det være greit å bruke to stoler? Fra denne stolen ramser du opp prestasjonene og argumenterer for å blokkere skammen; så bytter vi og hører fra den skamfulle siden som står igjen når listen tar slutt."
    },
    "dp_marker-recognition-chairwork_case-david_07": {
      ...
      "suggestion": "Det høres ut som en katastrofebekymring gjør én feil til total avsløring. Vi kan sette bekymringen i én stol og la den si nøyaktig hva den tror skjer hvis du innrømmer én feil; så bytter vi til siden som står under det presset og hører hvordan det er å leve med de scenene."
    },
    "dp_marker-recognition-chairwork_case-david_08": {
      ...
      "suggestion": "Det høres ut som et uavsluttet oppgjør med kona di rundt å bli sett og kanskje forlatt. Hvis du vil, kan vi hente henne inn i den tomme stolen og la deg si den setningen forsiktig, uten at du må forsvare den."
    },
    ...
    "dp_marker-recognition-chairwork_case-marcus_04": {
      ...
      "suggestion": "Det høres ut som en selvkritisk stemme avviser virkningen av det som skjedde. Hvis det kjennes mulig, kan vi sette den stemmen i én stol og delen som fortsatt bærer det i den andre. Start som den avvisende stemmen: si til ham at han burde vært over det nå."
    },
    ...
    "dp_marker-recognition-chairwork_case-marcus_07": {
      ...
      "suggestion": "Det høres ut som en bekymringsdel holder deg på vakt. Ville du være villig til å sette bekymringen i denne stolen? La den advare deg mot søvn og hva som kan skje; så bytter vi og hører fra den utslitte siden."
    },
    "dp_marker-recognition-chairwork_case-marcus_08": {
      ...
      "suggestion": "Det er et uavsluttet oppgjør med faren din rundt vold og frykt i hjemmet. Hvis du velger å prøve, kan vi hente ham inn i den tomme stolen og la deg si den linjen direkte, med nok pauser til at du holder deg forankret."
    },
    "dp_marker-recognition-chairwork_case-marcus_09": {
      ...
      "suggestion": "Det høres ut som en selvkritisk stemme gjør det å trenge hjelp til bevis på at du er ubrukelig, og så stopper den deg fra å spørre. Vi kan sette den stemmen i én stol og delen som trenger hjelp i den andre. Fra denne stolen sier du «hva duger du egentlig til?»; så bytter vi og lar den trengende siden svare uten å bli presset."
    },
    ...
    "dp_alliance-repair_case-laura_03": {
      ...
      "suggestion": "Takk for at du betror meg den bekymringen. Aldersforskjellen er reell, og hvis jeg oppfører meg som om jeg automatisk forstår, kan jeg gå glipp av lengden og ensomheten i det du har levd med. Jeg beklager de gangene jeg kan ha gått forbi det. Hva ville hjulpet deg å teste om jeg forstår livet ditt på dine premisser?"
    },
    ...
    "dp_alliance-repair_case-laura_07": {
      ...
      "suggestion": "Takk for at du stoppet meg der. Jeg gikk mot stolarbeid før jeg hadde samtykket ditt til hvor stort det kjentes, og det beklager jeg. At det kanskje kan hjelpe senere, betyr ikke at det var riktig da. Hva ville vært en tryggere kant der du fortsatt kjenner at du styrer?"
    },
    ...
    "dp_alliance-repair_case-carlos_03": {
      ...
      "suggestion": "Takk for at du sier det. At jeg så bort mens du prøvde å møte frykten til sønnen din, kunne kjennes som om selv jeg ikke orket å se på det som skjedde, og det beklager jeg. Jeg vil holde begge ting samtidig: skaden betyr noe, og jeg vender meg ikke bort fra deg. Hva ville hjulpet deg å kjenne at jeg kan se stødig på dette sammen med deg?"
    },
    ...
    "dp_alliance-repair_case-carlos_07": {
      ...
      "suggestion": "Takk for at du sier det. Da jeg kikket mot døra, så det ut som om jeg trengte en fluktvei, og jeg skjønner hvor ydmykende og urovekkende det kunne kjennes. Det beklager jeg. Jeg vil være tydelig på trygghet uten å behandle deg som en jeg må komme meg bort fra. Hva ville hjelpe oss å gjenopprette nok tillit til stødigheten min akkurat nå?"
    },
    ...
    "dp_alliance-repair_case-nina_04": {
      ...
      "suggestion": "Takk for at du forteller meg det. Måten jeg brukte «grenser» på hørtes ut som en korrigering eller karakter, og jeg beklager at det matet følelsen av å mislykkes. Hvilke ord ville hjulpet oss å snakke om grensene dine uten at du føler deg defekt eller på etterskudd?"
    },
    ...
    "dp_alliance-repair_case-nina_08": {
      ...
      "suggestion": "Takk for at du sier det. Ordet «bitterhet» landet som om jeg navnga noe stygt i deg, og det beklager jeg. Jeg vil at språket skal respektere såretheten og utmattelsen under. Hvilket ord lar oss bli ved det uten at du føler deg slem?"
    },
    ...
    "dp_alliance-repair_case-aisha_05": {
      ...
      "suggestion": "Takk for at du setter ord på det. Grensespråket mitt landet som straff for å trenge, og det beklager jeg. Rammen må være tydelig, men den må også kjennes omsorgsfull heller enn avvisende. Hva ville hjulpet grensen å kjennes som stødighet i stedet for avstand?"
    },
    "dp_alliance-repair_case-aisha_06": {
      ...
      "suggestion": "Takk for at du forteller meg det. Da øynene mine ble store, følte du deg skremmende og ansvarlig for å ta vare på meg, og det beklager jeg. Jeg må være stødig nok til at du kan snakke om kutting uten å håndtere reaksjonen min. Hva ville hjulpet deg å kjenne at jeg kan holde sikkerhet i sikte og samtidig bli hos deg?"
    },
    ...
    "dp_alliance-repair_case-david_03": {
      ...
      "suggestion": "Takk for at du forteller meg det. Da jeg navnga hennes sårhet først, hørtes det ut som om jeg stod på hennes side og gjorde din mindre viktig, og det beklager jeg. Før vi snakker om smerten hennes igjen, hvilken del av din trenger jeg å forstå så du ikke føler deg i mindretall her?"
    },
    "dp_alliance-repair_case-david_04": {
      ...
      "suggestion": "Takk for at du forteller meg det. Tonen min gjorde utfordringen til ydmykelse, og det beklager jeg. Jeg vil at utfordring skal tjene arbeidet, ikke gjenta det å bli satt på plass. Hva ville gjort en utfordring respektfull nok til at du fortsatt kunne høre den?"
    },
    ...
    "dp_alliance-repair_case-david_06": {
      ...
      "suggestion": "Takk for at du setter ord på det. Hvis jeg hørte tårene hennes som smerte og skarpheten din bare som arroganse, overså jeg deg, og det beklager jeg. Hva trengte smerten din fra meg i det øyeblikket, så den ikke måtte komme pakket inn i skarphet?"
    },
    ...
    "dp_alliance-repair_case-marcus_02": {
      ...
      "suggestion": "Takk for at du sier det direkte. At jeg flyttet meg nærmere gjorde deg urolig og fanget, og jeg beklager at jeg endret avstanden uten å sjekke. Hvor i rommet ville det kjennes tryggere at jeg var?"
    },
    ...
    "dp_alliance-repair_case-marcus_04": {
      ...
      "suggestion": "Takk for at du sier det. Å be deg lukke øynene overså hva trygghet og orientering krever for deg, og det beklager jeg. Vi trenger ikke gjøre det. Hvilke måter å lande på lar deg beholde nok kontroll over rommet og samtidig være her?"
    },
    ...
    "dp_alliance-repair_case-marcus_06": {
      ...
      "suggestion": "Takk for at du forteller meg det. Hvis ubehaget syntes i ansiktet mitt, ble du stående og gjøre volden mindre så jeg kunne tåle den, og det beklager jeg. Du skal ikke måtte beskytte meg mot historien din. Hva ville hjulpet deg å vite at jeg kan høre det uten å vende meg bort eller trenge at du håndterer meg?"
    },
    ...
    "dp_alliance-repair_case-marcus_08": {
      ...
      "suggestion": "Takk for at du sier det. At jeg satt mellom deg og døra, preget hele timen før vi engang hadde ord for det, og jeg beklager at jeg ikke sjekket rommet med deg. La oss endre det nå. Hvor bør jeg sitte så kroppen din kan følge med på utgangen og samtidig være i kontakt med meg?"
    },
    "dp_alliance-repair_case-marcus_09": {
      ...
      "suggestion": "Takk for at du sier det. «Du er trygg her» hørtes for rent ut og fikk meg til å virke naiv om hva trygghet betyr for deg, og det beklager jeg. Jeg vil ikke at ordene mine skal viske ut det kroppen din vet. Hvilken formulering ville kjennes mer presis for den typen trygghet vi kan bygge i dette rommet?"
    },
    "dp_alliance-repair_case-marcus_10": {
      ...
      "suggestion": "Takk for at du forteller meg det. Å vende tilbake dit igjen og igjen har kjentes som graving, og jeg beklager at jeg ikke sjekket det. Jeg vil ikke at nåtiden din bare skal bli bevis for fortiden. Hva ville fått det til å kjennes som at du styrer om og når vi nærmer oss det stoffet?"
    }
  }
};
